...
class RawU_Net(nn.Module):
    """
    UNet - Basic Implementation
    Paper : https://arxiv.org/abs/1505.04597
    """
    def __init__(self, in_ch=4, out_ch=4):
        super(RawU_Net, self).__init__() 
    ...
    def forward(self, x):
        ...
        out = self.Conv(d2) 
        out = out[:,:,2:-2,2:-2] 
        out = F.interpolate(out, (252, 252)) 
        out = torch.clamp(out, min=0., max=1.) 
        #d1 = self.active(out)

        return out

class RGBU_Net(nn.Module):
    """
    UNet - Basic Implementation
    Paper : https://arxiv.org/abs/1505.04597
    """
    def __init__(self, in_ch=4, out_ch=4):
        super(RGBU_Net, self).__init__() 
...
class RawAttU_Net(nn.Module):
    """
    Attention Unet implementation
    Paper: https://arxiv.org/abs/1804.03999
    """
    def __init__(self, img_ch=4, output_ch=4):
        super(RawAttU_Net, self).__init__()
...
class R2AttU_Net(nn.Module):
    ...
    """
    def __init__(self, in_ch=4, out_ch=4, t=2):
...
# RGB to Raw 
class RawR2AttU_Net(nn.Module):
    """
    Residual Recuurent Block with attention Unet
    Implementation : https://github.com/LeeJunHyun/Image_Segmentation
    """
    def __init__(self, in_ch=4, out_ch=4, t=2):
        super(RawR2AttU_Net, self).__init__()
...
# RGB to RGB 
class RGBR2AttU_Net(nn.Module):
    """
    Residual Recuurent Block with attention Unet
    Implementation : https://github.com/LeeJunHyun/Image_Segmentation
    """
    def __init__(self, in_ch=4, out_ch=3, t=2):
        super(RGBR2AttU_Net, self).__init__()
...
# RGB to RGB 
class RGBNestedUNet(nn.Module):
    """
    Implementation of this paper:
    https://arxiv.org/pdf/1807.10165.pdf
    """
    def __init__(self, in_ch=4, out_ch=3):
        super(RGBNestedUNet, self).__init__()
...
# RGB to Raw 
class RawNestedUNet(nn.Module):
    """
    Implementation of this paper:
    https://arxiv.org/pdf/1807.10165.pdf
    """
    def __init__(self, in_ch=4, out_ch=4):
        super(RawNestedUNet, self).__init__()
...
# Raw to Raw 
class SmallNestedUNet(nn.Module):
    """
    Implementation of this paper:
    https://arxiv.org/pdf/1807.10165.pdf
    """
    def __init__(self, in_ch=4, out_ch=4):
        super(SmallNestedUNet, self).__init__()
...
# Raw to Raw 
class L2NestedUNet(nn.Module):
    """
    Implementation of this paper:
    https://arxiv.org/pdf/1807.10165.pdf
    """
    def __init__(self, in_ch=4, out_ch=4):
        super(L2NestedUNet, self).__init__() 
